      ...
      GridLayout {
        ...
        Item {
          ...
          RippleMouseArea {
            ...
            anchors.centerIn: parent
            onClicked: {
              amplitude.logEvent("Open Talk In Browser", {"title" : talk.title, "talkId" : talk.id, "url" : "http://www.qtworldsummit.com/2019/sessions/"+talk.slug})
              nativeUtils.openUrl("http://www.qtworldsummit.com/2019/sessions/"+talk.slug)
            }
          }
        }
        ...
        Item {
          ...
          RippleMouseArea {
            ...
            onClicked: {
              ...
              nativeUtils.share("I am attending \"" + talk.title + "\" at Qt World Summit 2019!","http://www.qtworldsummit.com/2019/sessions/"+talk.slug)
            }
          }
        }
      } // icon grid
